...
async def predict_dog_breed(file: UploadFile = File(...)):
    ...
    breed = idx_to_breed[predicted_idx.item()]
    return {"predicted_breed": breed}

@app.get("/")
def read_root():
    return {"message": "강아지 품종 분류 API 서버"}